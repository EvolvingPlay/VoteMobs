package com.whiteline.votemobs.world.items;

import com.whiteline.votemobs.world.entity.ThrownOstrichEgg;
...
public class OstrichEgg extends EggItem {
    public OstrichEgg(Properties p_41126_) {
        super(p_41126_);
    }
    public InteractionResultHolder<ItemStack> use(Level p_41128_, Player p_41129_, InteractionHand p_41130_) {
        ...
        if (!p_41128_.isClientSide) {
            ThrownOstrichEgg thrownegg = new ThrownOstrichEgg(p_41128_, p_41129_);
