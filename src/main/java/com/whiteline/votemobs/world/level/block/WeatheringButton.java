...
public interface WeatheringButton extends WeatheringCopper {
    Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> {
        return ImmutableBiMap.<Block, Block>builder().put(Registry.COPPER_BUTTON.get(), Registry.EXPOSED_BUTTON.get()).put(Registry.EXPOSED_BUTTON.get(), Registry.WEATHERED_BUTTON.get()).put(Registry.WEATHERED_BUTTON.get(), Registry.OXIDIZED_BUTTON.get()).build();
    });
