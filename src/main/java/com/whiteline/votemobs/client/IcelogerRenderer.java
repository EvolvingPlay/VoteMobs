...
public class IcelogerRenderer extends MobRenderer<Iceloger, IllagerModel<Iceloger>> {
    ...
    public IcelogerRenderer(EntityRendererProvider.Context context) {
        super(context, new IllagerModel<>(context.bakeLayer(VoteMobsModelLayers.ICELOGER)), 0.4F);
    }
}